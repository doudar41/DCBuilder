...
Shader "BDSprite"
{
	Properties
	{
		...
		[Toggle(_FLIPLIGHTING_ON)] _FlipLighting("FlipLighting", Float) = 0
		...
		SubShader
		{
			...
			#pragma shader_feature_local _FLIPLIGHTING_ON
			...
			inline half4 LightingStandardCustomLighting(inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi)
			{
				...
				float4 temp_cast_3 = ((temp_output_217_0 * 1.0)).xxxx;
				#ifdef _VISUALIZEKEYMASK_ON
					float4 staticSwitch215 = temp_cast_3;
				#else
				...
				#endif //aseld
				float dotResult154 = dot(ase_worldNormal , ase_worldlightDir);
				#ifdef _FLIPLIGHTING_ON
					float staticSwitch230 = -dotResult154;
				#else
					float staticSwitch230 = dotResult154;
				#endif
				...
				#endif //aselc
				UnityGI gi155 = gi;
				float3 diffNorm155 = ase_worldNormal;
				gi155 = UnityGI_Base(data, 1, diffNorm155);
				float3 indirectDiffuse155 = gi155.indirect.diffuse + diffNorm155 * 0.0001;
				#ifdef UNITY_PASS_FORWARDADD
					float4 staticSwitch209 = (ase_lightColor * float4((indirectDiffuse155 + ase_lightAtten) , 0.0));
				#else
					float4 staticSwitch209 = ((saturate(((1.0 * staticSwitch230) * 1.0)) * ase_lightColor) + UNITY_LIGHTMODEL_AMBIENT);
				#endif
				float4 temp_cast_5 = (1.0).xxxx;
				float4 lerpResult199 = lerp(staticSwitch209 , temp_cast_5 , (1.0 - MainTexAlpha183));
				float3 appendResult43 = (float3(break42.x , break42.y , break42.z));
				c.rgb = (lerpResult199 * float4(appendResult43 , 0.0)).rgb;
				c.a = break42.w;
				return c;
			}
...
/*ASEBEGIN
Version=18800
420;106;2248;1004;2274.378;1534.158;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;185;-2076.407,347.9306;Inherit;False;Property;_KeyColor;KeyColor;12;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.1018915,0,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;189;-1824.378,424.0894;Inherit;False;Property;_MaskRange;MaskRange;13;0;Create;True;0;0;0;False;0;False;0;1.46;-1;1.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;171;-1667.963,-1518.283;Inherit;False;2813.909;794.3931;Comment;15;164;161;159;156;151;149;162;199;201;204;205;209;227;230;231;Custom Lighting;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;224;-838.66,377.4875;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;231;-1449.378,-938.1583;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;230;-1275.378,-957.1583;Inherit;False;Property;_FlipLighting;FlipLighting;16;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;151;-929.3005,-1399.272;Inherit;False;829;381;Comment;6;163;158;157;226;155;153;Attenuation and Ambient;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;164;-215.2078,-893.3745;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FogAndAmbientColorsNode;226;-714.2773,-1106.065;Inherit;False;UNITY_LIGHTMODEL_AMBIENT;0;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;227;-0.2773438,-1013.065;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;40;470.9038,-330.5001;Inherit;False;Property;_UseOutline;UseOutline;2;0;Create;True;0;0;0;False;0;False;0;1;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;205;382.317,-966.8427;Inherit;False;Constant;_Float4;Float 4;16;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RelayNode;172;1408.092,-552.5701;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;173;1575.124,-496.5193;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;82;-881.1412,2083.907;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1774.84,-278.3481;Float;False;True;-1;2;ASEMaterialInspector;0;0;CustomLighting;BDSprite;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=9329FAD769F088C46A32165109FECCD78C529B17